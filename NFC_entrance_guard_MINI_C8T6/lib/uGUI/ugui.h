...
void UG_FillScreen( UG_COLOR c );//填充屏幕
...
void UG_DrawPixel( UG_S16 x0, UG_S16 y0, UG_COLOR c );//画点
void UG_DrawCircle( UG_S16 x0, UG_S16 y0, UG_S16 r, UG_COLOR c );//画圆
void UG_FillCircle( UG_S16 x0, UG_S16 y0, UG_S16 r, UG_COLOR c );//填充圆
void UG_DrawArc( UG_S16 x0, UG_S16 y0, UG_S16 r, UG_U8 s, UG_COLOR c );//画圆弧
void UG_DrawLine( UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_COLOR c );//画线
